...
describe('AppLogger', () => {
  ...
  describe('context management', () => {
    it('should set and clear context', () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(
        'Test message | userId=user123 requestId=req456',
      );
  ...
  describe('basic logging methods', () => {
    it('should log messages', () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(
        'Test log message | context=TestContext',
      );
    });
    ...
    it('should log errors', () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        'Test error message | context=TestContext',
        'stack trace',
      );
    });
    ...
    it('should log warnings', () => {
      ...
      expect(mockLogger.warn).toHaveBeenCalledWith(
        'Test warning message | context=TestContext',
      );
    });
    ...
    it('should log debug messages', () => {
      ...
      expect(mockLogger.debug).toHaveBeenCalledWith(
        'Test debug message | context=TestContext',
      );
    });
    ...
    it('should log verbose messages', () => {
      ...
      expect(mockLogger.verbose).toHaveBeenCalledWith(
        'Test verbose message | context=TestContext',
      );
    });
  });
  ...
  describe('context-aware logging methods', () => {
    it('should log with context', () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(
        'User logged in | userId=user123 action=login',
      );
    });
    ...
    it('should log errors with context', () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        'An error occurred | userId=user123 action=error',
        'stack trace',
      );
    });
    ...
    it('should log warnings with context', () => {
      ...
      expect(mockLogger.warn).toHaveBeenCalledWith(
        'A warning occurred | userId=user123 action=warning',
      );
    });
    ...
    it('should log debug with context', () => {
      ...
      expect(mockLogger.debug).toHaveBeenCalledWith(
        'Debug information | userId=user123 action=debug',
      );
    });
  });
  ...
  describe('request logging methods', () => {
    it('should log requests', () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(
        'GET /api/users | method=GET url=/api/users userAgent=Mozilla/5.0',
      );
    });
  ...
  describe('business logic logging methods', () => {
    ...
    it('should log security events', () => {
      service.logSecurityEvent('failed_login', 'user123', '192.168.1.1', {
        attempts: 3,
      });
  ...
  describe('message formatting', () => {
    ...
    it('should filter undefined values from context', () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(
        'Test message | userId=user123 action=test',
      );
    });
