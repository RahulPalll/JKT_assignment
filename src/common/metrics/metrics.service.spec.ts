...
describe('MetricsService', () => {
  ...
  describe('histogram methods', () => {
    it('should record histogram values', () => {
      ...
      const histogram = service.getHistogram('test_histogram', { endpoint: '/users' });
    ...
    it('should record histogram values for different endpoints', () => {
      ...
      const usersHistogram = service.getHistogram('test_histogram', { endpoint: '/users' });
      const docsHistogram = service.getHistogram('test_histogram', { endpoint: '/docs' });
  ...
  describe('business metrics', () => {
    ...
    it('should record database operations', () => {
      ...
      const histogram = service.getHistogram('database_operation_duration_seconds', {
        operation: 'SELECT',
        table: 'users'
      });
      expect(histogram).toBeDefined();
